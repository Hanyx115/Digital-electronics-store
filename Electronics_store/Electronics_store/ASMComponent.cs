...
namespace Electronics_store
{
    class Person
    {
        ...
        public int Age
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("Your age must be greater then 18");
                }
            }
        }
    ...
    class Address
    {
        ...
        public Address(string stname, double stnum, int flnum, int num, string c)
        {
            ...
            {
                Console.WriteLine("if issues occured recheck your Address");
            }
        ...
        public double Streetnum
        {
            ...
            set
            {
                if (value > 0)
                    ...
                    throw new ArgumentException("Street number must be greater than 0");
            }
        }
        ...
        public int Floornum
        {
            ...
            set
            {
                if (value > 0)
                    ...
                    throw new ArgumentException("Floor number must be greater than 0");
            }
        }
        ...
        public int Flatnum
        {
            ...
            set
            {
                if (value > 0)
                    ...
                    throw new ArgumentException("Flat number must be greater than 0");
            }
        }
    }
